...
exec(`${tslintBin} -p ${tsconfig} -c ${tslintConfig} -r .. -t ${tslintFormat} ${tsFiles}`, { cwd: __dirname }, (error, stdout, stderr) => {
  ...
  assert.deepEqual(actual, [
      ...
      // case2
      {
        ...
        name: `${__dirname}/case2.ts`
      },

      // case3
      {
        failure: 'circular import detected: case3/b.ts -> case3/a.ts -> case3/b.ts',
        name: '/Users/hansl/Sources/hansl/tslint-no-circular-imports/test/case3/b.ts'
      },

      // case4
      {
        failure: 'circular import detected: case4/index.ts -> case4/a.ts -> case4/index.ts',
        name: '/Users/hansl/Sources/hansl/tslint-no-circular-imports/test/case4/index.ts'
      }
  ])
})
